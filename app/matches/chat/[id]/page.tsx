    ...
    <div className="flex h-screen bg-[#fafafe] overflow-hidden text-slate-900">
      ...
      <aside className="hidden lg:flex w-80 shrink-0 flex-col border-r border-slate-200 bg-white">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 text-sm">
          <p className="text-xs text-slate-400 uppercase tracking-wider mb-2 font-semibold">Dica de Conversa</p>
      ...
      <main className="flex-1 min-w-0 flex flex-col bg-[#fafafe]">
        <header className="border-b border-slate-200 bg-white">
          <div className="px-5 md:px-8 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <p className="text-[10px] uppercase tracking-[0.22em] text-orange-500 font-bold mb-0.5">
                  Match na Região
                </p>
            ...
            <button
              onClick={() => router.push('/matches')}
              className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2.5 text-slate-600 hover:bg-slate-50 transition-all text-sm"
            >
              <ChevronLeft size={16} />
        ...
        <form
          ...
          className="border-t border-slate-200 bg-white px-4 md:px-8 py-4"
        >
          <div className="flex items-center gap-3">
            <div className="flex-1 rounded-full border border-slate-200 bg-slate-50 px-5 py-2 focus-within:border-orange-300 focus-within:bg-white transition-all">
              <input
                ...
                className="w-full bg-transparent outline-none py-2 text-sm text-slate-800 placeholder:text-slate-400 font-medium"
              />
            </div>

            <button
              type="submit"
              className="w-12 h-12 rounded-full bg-orange-600 hover:bg-orange-700 text-white flex items-center justify-center shadow-sm transition-all active:scale-95 shrink-0"
            >
              <Send size={18} />
            </button>
          </div>
