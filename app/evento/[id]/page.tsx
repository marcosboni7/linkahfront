...
export default function DetalhesEvento() {
  ...
  if (!evento) return (
    <div className="p-20 text-center">
      <p className="text-slate-500 font-medium mb-4">Evento não encontrado ou indisponível.</p>
      <Link href="/" className="text-[#E30031] font-bold underline">Voltar para a página inicial</Link>
    </div>
  );

  // Lógica de Ingressos e Preço
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-24">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            <button className="p-2.5 rounded-full border border-slate-200 hover:bg-slate-50 text-slate-600 transition-all">
              <Share2 size={18} />
            </button>
            <button className="p-2.5 rounded-full border border-slate-200 hover:bg-slate-50 text-slate-600 transition-all">
              <Heart size={18} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-start gap-4 p-6 rounded-3xl bg-slate-50 border border-slate-100">
                ...
                <div>
                  ...
                  <p className="font-bold text-slate-800 line-clamp-1">
                    {evento.tipo === 'Online' ? 'Evento Online' : (evento.local_nome || 'Local não definido')}
                  </p>
                  <p className="text-xs text-slate-500 line-clamp-1">
                    {evento.cidade || 'Remoto'}, {evento.estado || 'BR'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-3xl bg-slate-50 border border-slate-100">
                ...
                <div>
                  ...
                  <button className="text-xs text-[#E30031] font-bold hover:underline">Ver perfil</button>
                </div>
              </div>
            </div>
                ...
                <div className="p-8 md:p-10 space-y-8">
                    ...
                    <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                      ...
                      <div className="flex items-center gap-5">
                        <button 
                          ...
                          className="w-8 h-8 rounded-full bg-white border border-slate-200 flex items-center justify-center shadow-sm hover:bg-slate-100"
                        >
                          <Minus size={14} />
                        </button>
                  ...
                  <div className="pt-6 border-t-2 border-dashed border-slate-100 space-y-4">
                    ...
                    <Link 
                      ...
                      className="flex items-center justify-center w-full bg-[#E30031] py-6 rounded-[2rem] font-black text-white uppercase text-xs tracking-widest gap-3 hover:bg-red-700 transition-all shadow-lg active:scale-95"
                    >
