  ...
  return (
    <div className="flex min-h-screen bg-white font-sans antialiased text-[#1D1D1F]">
      ...
      <div className="hidden lg:flex w-[50%] relative overflow-hidden bg-black">
        ...
        <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-60 scale-105 animate-pulse-slow"
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full">
          ...
          <div className="max-w-md">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-6">
               ...
               <span className="text-[10px] font-bold text-white uppercase tracking-widest">Acesso Exclusivo</span>
            </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-8 lg:px-20 bg-white">
        <div className="w-full max-w-[420px]">
          ...
          <header className="mb-10">
            ...
            <p className="text-gray-500 font-medium">Bem-vindo de volta à Linkah.</p>
          </header>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-6 py-5 bg-white border border-gray-100 rounded-2xl outline-none focus:border-black focus:ring-4 focus:ring-gray-50 transition-all font-semibold text-black placeholder:text-gray-300 shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <button type="button" className="text-[10px] font-bold text-gray-400 hover:text-black transition-colors uppercase tracking-widest">Esqueceu?</button>
              </div>
              <div className="relative">
          ...
          <footer className="mt-12 text-center">
            <p className="text-[12px] font-bold text-gray-400">
              Ainda não faz parte? <Link href="/auth/registro" className="text-black hover:underline ml-1">Criar conta</Link>
            </p>
          </footer>
        </div>
      </div>
