                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-5 space-y-3">
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full min-h-[140px] bg-slate-50/50 border border-slate-100 px-6 py-5 rounded-[1.8rem] outline-none focus:bg-white focus:border-black font-medium text-black transition-all resize-none leading-relaxed"
                      placeholder={`Ex:\n• Open bar\n• Área VIP\n• Camarote exclusivo\n• Brinde especial`}
                    />
                  </div>
