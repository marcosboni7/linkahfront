  ...
  return (
    <div className="bg-pink-50 border border-pink-100 rounded-[2rem] p-8 mb-8 flex flex-col items-start gap-4">
      <h2 className="text-[#C22973] text-2xl font-bold">
        {t.producerAlertTitle || 'Atenção Produtor'}
      </h2>
      <p className="text-slate-500 font-medium">
        {t.producerAlertSub || 'Configure seus dados de pagamento para liberar o Pix e Stripe.'}
      </p>
      ...
      >
        {t.btnConfigureData || 'Configurar Agora'}
      </button>
    </div>
  );
}