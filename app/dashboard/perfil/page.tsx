...
function PerfilContent() {
  ...
  const salvarPerfilCompletoNoStorage = useCallback((data: Partial<FormDataState>) => {
    const completo = perfilJaCompleto(data);
    ...
    const carregarDados = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const dadosPerfil: FormDataState = {
            nome: data.nome || '',
          ...
          salvarPerfilCompletoNoStorage(dadosPerfil);
  ...
  const handleSalvar = async (e: React.FormEvent) => {
    ...
    try {
      ...
      salvarPerfilCompletoNoStorage(formData);
        ...
        <div className="bg-white rounded-[4rem] shadow-2xl p-8 md:p-20 border border-slate-50 relative overflow-hidden">
          <div className="flex items-center gap-8 mb-20 relative z-10">
            <div
              ...
              className="w-24 h-24 bg-slate-950 rounded-[2.5rem] flex items-center justify-center shadow-2xl relative group cursor-pointer overflow-hidden"
            >
              {isUploadingAvatar ? (
          ...
          <form onSubmit={handleSalvar} className="space-y-12 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 italic ml-2">
                  Nome Completo
                </label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border-none rounded-3xl py-6 pl-16 pr-8 text-slate-900 font-bold placeholder:text-slate-300 focus:ring-4 focus:ring-[#FF4D4D]/10 transition-all"
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="md:col-span-2 space-y-4">
                ...
                <div className="relative group">
                  <AlignLeft
                    className="absolute left-6 top-8 text-slate-300 group-focus-within:text-[#FF4D4D] transition-colors"
                    size={20}
                  />
                  <textarea
                    name="bio"
                    ...
                    rows={3}
                    className="w-full bg-slate-50 border-none rounded-3xl py-6 pl-16 pr-8 text-slate-900 font-bold placeholder:text-slate-300 focus:ring-4 focus:ring-[#FF4D4D]/10 transition-all resize-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="pt-10 flex flex-col md:flex-row gap-6">
              <button
                type="submit"
                disabled={isSaving}
                className="flex-1 bg-[#FF4D4D] text-white rounded-[2rem] py-8 font-black uppercase tracking-[0.4em] italic text-xs shadow-2xl shadow-[#FF4D4D]/40 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-4 disabled:opacity-50"
              >
              ...
              {!stripeAtivo ? (
                <button
                  ...
                  className="flex-1 bg-slate-950 text-white rounded-[2rem] py-8 font-black uppercase tracking-[0.4em] italic text-xs shadow-2xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-4"
                >
                ...
                <div className="flex-1 bg-emerald-50 border-2 border-emerald-100 rounded-[2rem] p-6 flex items-center gap-6">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-600 italic">
                      Stripe Ativo
                    </p>
