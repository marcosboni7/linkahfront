...
// IMPORTANTE: Verifique se o Sidebar.tsx está realmente um nível acima
...
export default function AdminEventos() {
  ...
  const carregarDados = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Filtra os excluídos para não poluir a tabela
  ...
  return (
    <div className="flex min-h-screen bg-[#F4F5F7] text-slate-900">
      {/* Sidebar sem props - ela se vira sozinha com a URL agora */}
      <Sidebar />
                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-5">
                          ...
                          <div>
                            ...
                            <span className="text-[10px] font-black uppercase text-[#ff4d4d] bg-[#ff4d4d]/10 px-2 py-0.5 rounded">
                              {ev.categoria}
                            </span>
                          </div>
                        </div>
                      ...
                      <td className="px-8 py-6 text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <button 
                            ...
                            disabled={isProcessing === ev.id}
                            className="p-2 hover:bg-red-50 hover:text-red-500 rounded-lg text-slate-400 transition-all"
                          >
                            <Trash2 size={18} />
                          </button>
                        </div>
      ...
      {isModalOpen && eventoParaEditar && (
        <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-md z-50 flex items-center justify-center p-6">
          <div className="bg-white w-full max-w-xl rounded-[3rem] p-10 shadow-2xl animate-in zoom-in-95 duration-200">
