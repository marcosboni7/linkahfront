    ...
    <div className="min-h-screen bg-[#FCFBFA] flex flex-col md:flex-row font-sans">
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-16 bg-[#FCFBFA]">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-10">
            <h1 className="text-4xl font-bold text-slate-950 tracking-tight mb-3">Login</h1>
            <p className="text-slate-500 font-light">Entre com suas credenciais para continuar.</p>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-white border border-slate-100 rounded-[1.25rem] py-4 pl-14 pr-6 text-sm outline-none focus:ring-4 focus:ring-[#ff4d4d]/5 focus:border-[#ff4d4d] shadow-sm transition-all placeholder:text-slate-200"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <button type="button" className="text-[11px] font-medium text-slate-400 hover:text-slate-900 transition-colors">Esqueceu?</button>
              </div>
              <div className="relative group">
            ...
            >
              {loading ? <Loader2 className="animate-spin" size={20} /> : (
                <>Entrar na conta <ArrowRight size={18} className="text-[#ff4d4d]" /></>
              )}
            </button>
          </form>
          ...
          <div className="mt-12 text-center">
             <p className="text-sm font-medium text-slate-400">
               Ainda não tem conta?
               <Link href="/site/register" className="text-slate-900 font-bold ml-2 hover:underline underline-offset-4 decoration-[#ff4d4d] decoration-2">
                 Criar agora
               </Link>
             </p>
          </div>
