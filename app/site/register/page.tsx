    ...
    <div className="min-h-screen bg-[#FCFBFA] flex flex-col md:flex-row font-sans">
        ...
        <div className="relative z-10 p-12 text-center max-w-lg">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-lg font-light leading-relaxed">
              Garanta seu lugar nos melhores eventos e conecte-se com novas comunidades.
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-16 bg-[#FCFBFA]">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-10">
            <h1 className="text-4xl font-bold text-slate-950 tracking-tight mb-3">Comece agora</h1>
            <p className="text-slate-500 font-light">Preencha os campos para criar seu perfil.</p>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-900 ml-1">Nome Completo</label>
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-white border border-slate-100 rounded-[1.25rem] py-4 pl-14 pr-6 text-sm outline-none focus:ring-4 focus:ring-[#ff4d4d]/5 focus:border-[#ff4d4d] shadow-sm transition-all"
                />
              </div>
            </div>
            ...
            {/* SENHA */}
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-900 ml-1">Criar Senha</label>
              <div className="relative group">
            ...
            <button 
              disabled={loading}
              type="submit"
              className="w-full bg-slate-950 text-white py-4 mt-4 rounded-[1.25rem] font-bold text-sm tracking-tight shadow-xl shadow-slate-200 hover:bg-black transition-all active:scale-[0.98] flex items-center justify-center gap-3 disabled:opacity-50"
            >
          ...
          <div className="mt-12 text-center">
             <p className="text-sm font-medium text-slate-400">
               ...
               <Link href="/site/login" className="text-slate-900 font-bold ml-2 hover:underline underline-offset-4 decoration-[#ff4d4d] decoration-2">
                 Fazer Login
               </Link>
             </p>
          </div>
