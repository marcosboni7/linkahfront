...
export default function BuyTicketHome() {
  ...
  return (
    <div className="bg-[#FCFCFD] min-h-screen text-slate-800 font-sans">
      ...
      {/* HERO SECTION - QUEBRA O BRANCO TOTAL COM IMPACTO */}
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <button className="bg-white text-black px-10 py-4 rounded-xl font-black uppercase text-xs tracking-widest hover:bg-[#ff0082] hover:text-white transition-all shadow-2xl flex items-center gap-2 mx-auto lg:mx-0">
                Explorar Tudo <ChevronRight size={18} />
              </button>
            </div>

            {/* BOX DE BUSCA INTEGRADO */}
            <div className="w-full max-w-[480px] bg-white rounded-[2rem] p-8 shadow-[0_30px_60px_rgba(0,0,0,0.3)]">
              <h3 className="text-slate-900 font-black uppercase text-sm tracking-widest mb-6 border-b border-slate-100 pb-4">
                Encontre seu evento
              </h3>
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-slate-100 rounded-xl py-4 pl-12 pr-4 text-sm outline-none focus:border-[#ff0082] transition-all"
                  />
                </div>
                <div className="relative">
      ...
      {/* NAVBAR DE CATEGORIAS (HORIZONTAL STICKY) */}
      ...
      <main className="max-w-6xl mx-auto px-6 py-20">
        <div className="flex items-center justify-between mb-12">
          ...
          <div className="bg-white px-4 py-1.5 rounded-full border border-slate-200 text-[10px] font-black uppercase text-slate-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {loading ? (
            ...
            <div className="col-span-full py-40 text-center border-2 border-dashed border-slate-200 rounded-[3rem] bg-white">
              ...
              <button onClick={() => setCategoriaAtiva('Todos')} className="mt-4 text-[#ff0082] font-bold underline underline-offset-4">
                Voltar para todos
              </button>
            </div>
          )}
